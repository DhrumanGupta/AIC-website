...
const highlights = [
  ...
  {
    title: "55 Analysts",
    description: "Collaborating to build conviction through fundamental research.",
    Icon: HiOutlineAcademicCap,
  },
  {
    title: "India's First Undergraduate Fund",
    description: "Managed by Ashoka University students with guidance from AIC.",
    Icon: HiOutlineSparkles,
  },
  {
    title: "AIC Supervision",
    description: "Part of Ashoka's investment club focused on finance and literacy.",
      ...
      <div id="start" className="min-h-screen">
        <section className="max-w-6xl lg:max-w-7xl mx-auto px-6 md:px-10 pt-20 pb-6">
          <p className="text-center text-xl md:text-2xl text-gray-900">
            Bodhi Capital: India&apos;s first undergraduate student-managed investment fund,
          ...
          <div className="max-w-6xl lg:max-w-7xl mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-800 leading-relaxed">
                Bodhi Capital is a student-run investment fund dedicated to the Indian equity
                markets. Our team of 4 portfolio managers, supported by 55 analysts, employs a
                rigorous fundamental analysis approach to identify promising investment
                opportunities. Supervised by AIC, Ashoka University&apos;s investment club, we&apos;re
                committed to fostering a culture of finance and investment within the university
                community.
              </p>
              <p className="mt-4 text-lg text-gray-800 leading-relaxed">
                AIC is a community of finance enthusiasts at Ashoka University, dedicated to
                fostering a culture of investment and financial literacy. We offer a range of
                opportunities for students to deepen their understanding of the investment world.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-gray-100 bg-white shadow-sm p-6">
                ...
                <p className="mt-3 text-gray-800">
                  We invest in companies with proven track records, strong management, and
                  sustainable competitive advantages. We view investments as long-term
                  partnerships aimed at enduring value and growth.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-100 bg-white shadow-sm p-6">
                ...
                <ul className="mt-3 space-y-2 text-gray-800">
                  <li className="flex gap-2">
                    ...
                    <span>
                      Speaker Sessions: Engage with industry leaders and sector experts through
                  ...
                  <li className="flex gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>
                      Industry Visits: Gain firsthand experience by visiting factories and other
                      relevant sites.
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>
                      Knowledge Building: Participate in workshops, seminars, and discussions to
                  ...
                  <li className="flex gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>
                      Networking: Connect with like-minded individuals and build valuable
                      relationships within the finance community.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="max-w-6xl lg:max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <p className="text-gray-700 md:max-w-xl">
              A fundamentals-first, long-term approach guided by discipline, literacy, and
              community building.
            </p>
          </div>
          ...
          <div className="max-w-6xl lg:max-w-7xl mx-auto px-6 md:px-10 text-white flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-white/90">
                Meet the team, explore our resources, and follow our work through the newsletter.
              </p>
            </div>
