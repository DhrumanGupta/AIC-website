...
import newletters from '../../../newsletters.json';
import Link from 'next/link';

// 5 good indian stock tickers for a demo website
const stocks = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'A', 'B', 'C'];
...
const finalNewsletters: Newsletter[] = newletters
  .sort((a, b) => {
...
const ResourcesPage = () => {
  return (
    <div className='mt-8'>
      ...
      <h2 className='text-3xl font-bold mt-8 w-full text-center mb-4'>Newsletters</h2>
      <div className='flex flex-col mx-4 sm:mx-12 md:max-w-[85ch] md:mx-auto md:px-4 gap-4'>
        ...
        <div className='w-full flex items-center justify-center'>
          <Link href='/newsletters' className='px-2 text-primary hover:brightness-90 transition-all duration-200 font-medium mx-auto'>
      ...
      <p className={'text-3xl font-bold w-full text-center mx-auto mb-4'}>Pitches</p>
